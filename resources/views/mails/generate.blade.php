...
<tr>
    <td style="background-color: #fff; padding: 30px 30px;">
        ...
        <p style="font-size: 16px; color: black; margin: 20px 0;"><strong> Company : {{$company}}</strong></p>
        <p style="font-size: 16px; color: black; margin: 20px 0;"><strong> Phone No : {{$phone}}</strong></p>
        <p style="font-size: 16px; color: black; margin: 20px 0;"><strong> Email : {{$subject_mail}}</strong></p>
        <p style="font-size: 16px; color: black; margin: 20px 0;">{!! $mail_message !!}</p>
